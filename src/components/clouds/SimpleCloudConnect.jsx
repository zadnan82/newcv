...
const SimpleCloudConnect = ({ darkMode, selectedProvider = 'google_drive' }) => {
  ...
  const providerConfigs = {
    'google_drive': {
      ...
      description: t('cloud3.save_cvs_securely_google'),
      connectedText: t('cloud3.google_drive_connected'),
      connectText: t('cloud3.connect_google_drive'),
      privacyText: t('cloud3.never_access_files'),
    },
    'onedrive': {
      name: 'OneDrive',
      icon: '☁️',
      ...
      description: t('cloud3.save_cvs_securely_onedrive', 'Save your CVs securely to OneDrive'),
      connectedText: t('cloud3.onedrive_connected', 'OneDrive Connected'),
      connectText: t('cloud3.connect_onedrive', 'Connect OneDrive'),
      privacyText: t('cloud3.never_access_files'),
    },
    'dropbox': {
      name: 'Dropbox',
      ...
      borderColor: 'border-blue-300',
      textColor: 'text-blue-600',
      description: t('cloud3.save_cvs_securely_dropbox', 'Save your CVs securely to Dropbox'),
      connectedText: t('cloud3.dropbox_connected', 'Dropbox Connected'),
      connectText: t('cloud3.connect_dropbox', 'Connect Dropbox'),
      privacyText: t('cloud3.never_access_files'),
    }
  };
