...
import { getSydneyStyles } from './SydneyStyles';
import { useTranslation } from 'react-i18next'; // Added for i18n support
 
// In Sydney.jsx, at the beginning of the component
const Sydney = ({ formData, customSettings, darkMode, isPdfMode = false }) => {
  ...
  const settings = {
    accentColor: customSettings?.accentColor || '#0072b1',
  ...
  const styles = getSydneyStyles(darkMode, settings, isPdfMode);
  ...
  return (
    <div style={styles.container} className={`sydney-template ${pdfClasses.container}`}>
      {/* Header with profile info and contact details */}
      <header style={styles.header} className={`sydney-header ${pdfClasses.header}`}>
      ...
      <div style={styles.contentLayout}>
        {/* Main column (left) */}
        <div style={styles.mainColumn} className="sydney-main-column">
          {/* Professional Summary */}
          {data.personal_info.summary && (
            <div style={styles.section} className={`sydney-summary-section ${pdfClasses.section}`}>
              <h2 style={styles.sectionTitle} className={`sydney-section-title ${pdfClasses.sectionTitle}`} data-section="summary">{t('resume.personal_info.summary')}</h2>
          ...
          {/* Work Experience */}
          {hasExperiences() && (
            <div style={styles.section} className={`sydney-experience-section ${pdfClasses.section}`}>
              <h2 style={styles.sectionTitle} className={`sydney-section-title ${pdfClasses.sectionTitle}`} data-section="experience">{t('resume.experience.title')}</h2>
              <div style={styles.sectionContent}>
                {data.experiences
                  .filter(exp => exp && exp.company)
                  .map((exp, index) => (
                    <div key={index} style={styles.expItem} className={`sydney-exp-item ${pdfClasses.expItem}`}>
          ...
          {/* Education */}
          {hasEducation() && (
            <div style={styles.section} className={`sydney-education-section ${pdfClasses.section}`}>
              <h2 style={styles.sectionTitle} className={`sydney-section-title ${pdfClasses.sectionTitle}`} data-section="education">{t('resume.education.title')}</h2>
              <div style={styles.sectionContent}>
                {data.educations
                  .filter(edu => edu && edu.institution)
                  .map((edu, index) => (
                    <div key={index} style={styles.expItem} className={`sydney-edu-item ${pdfClasses.expItem}`}>
                      <div style={styles.expHeader}>
          ...
          {/* Internships */}
          {hasInternships() && (
            <div style={styles.section} className={`sydney-internships-section ${pdfClasses.section}`}>
              <h2 style={styles.sectionTitle} className={`sydney-section-title ${pdfClasses.sectionTitle}`} data-section="internships">{t('resume.internships.title')}</h2>
              <div style={styles.sectionContent}>
                {data.internships
                  .filter(internship => internship && internship.company)
                  .map((internship, index) => (
                    <div key={index} style={styles.expItem} className={`sydney-internship-item ${pdfClasses.expItem}`}>
                      <div style={styles.expHeader}>
          ...
          {hasCustomSections() && 
            data.custom_sections
              ...
              .map((section, sectionIndex) => (
                <div key={`custom-${sectionIndex}`} style={styles.section} className={`sydney-custom-section ${pdfClasses.section}`}>
                  <h2 style={styles.sectionTitle} className={`sydney-section-title ${pdfClasses.sectionTitle}`} data-section={`custom-${sectionIndex}`}>{section.title || t('resume.custom_sections.title')}</h2>
                  <div style={styles.sectionContent}>
                    {/* If the section has items array, render them as individual entries */}
                    {section.items && section.items.length > 0 ? (
                      section.items.map((item, itemIndex) => (
                        <div key={`custom-item-${sectionIndex}-${itemIndex}`} style={styles.expItem} className={`sydney-custom-item ${pdfClasses.expItem}`}>
                          <div style={styles.expHeader}>
                      ...
                      <div style={styles.expItem} className={`sydney-custom-content ${pdfClasses.expItem}`}>
        ...
        <div style={styles.sidebar} className={`sydney-sidebar ${pdfClasses.sidebar}`}>
          {/* Personal Information */}
          {hasPersonalDetails() && (
            <div style={styles.sidebarSection} className={`sydney-personal-details-section ${pdfClasses.section}`}>
              <h2 style={styles.sidebarSectionTitle} className={`sydney-sidebar-title ${pdfClasses.sectionTitle}`} data-section="personal-details">{t('resume.personal_info.title')}</h2>
          ...
          {/* Skills */}
          {hasSkills() && (
            <div style={styles.sidebarSection} className={`sydney-skills-section ${pdfClasses.section}`}>
              <h2 style={styles.sidebarSectionTitle} className={`sydney-sidebar-title ${pdfClasses.sectionTitle}`} data-section="skills">{t('resume.skills.title')}</h2>
          ...
          {/* Languages */}
          {hasLanguages() && (
            <div style={styles.sidebarSection} className={`sydney-languages-section ${pdfClasses.section}`}>
              <h2 style={styles.sidebarSectionTitle} className={`sydney-sidebar-title ${pdfClasses.sectionTitle}`} data-section="languages">{t('resume.languages.title')}</h2>
          ...
          {/* Courses & Certifications - MOVED TO SIDEBAR */}
          {hasCourses() && (
            <div style={styles.sidebarSection} className={`sydney-courses-section ${pdfClasses.section}`}>
              <h2 style={styles.sidebarSectionTitle} className={`sydney-sidebar-title ${pdfClasses.sectionTitle}`} data-section="courses">{t('resume.courses.title')}</h2>
                ...
                {data.courses
                  ...
                  .map((course, index) => (
                    <div key={index} style={styles.courseItem}>
                      ...
                      {course.date && <div style={styles.courseDate}>{formatDate(course.date)}</div>}
                      {course.institution && <div style={styles.courseInstitution}>{course.institution}</div>}
                    </div>
                  ))}
              </div>
            </div>
          ...
          {/* Extra Curricular Activities - MOVED TO SIDEBAR */}
          {hasExtracurriculars() && (
            <div style={styles.sidebarSection} className={`sydney-extracurriculars-section ${pdfClasses.section}`}>
              <h2 style={styles.sidebarSectionTitle} className={`sydney-sidebar-title ${pdfClasses.sectionTitle}`} data-section="extracurriculars">{t('resume.extracurricular.activity')}</h2>
              <div style={styles.extracurricularsGrid}>
                {data.extracurriculars.map((activity, index) => (
                  <div key={index} style={styles.activityItem}>
                    <div style={styles.activityTitle}>{activity.title}</div>
                    {activity.description && <div style={styles.activityDescription}>{activity.description}</div>}
                  </div>
                ))}
              </div>
            </div>
          ...
          {/* Hobbies & Interests */}
          {hasHobbies() && (
            <div style={styles.sidebarSection} className={`sydney-hobbies-section ${pdfClasses.section}`}>
              <h2 style={styles.sidebarSectionTitle} className={`sydney-sidebar-title ${pdfClasses.sectionTitle}`} data-section="hobbies">{t('resume.hobbies.title')}</h2>
          ...
          {/* Referrals */}
          {hasReferences() && (
            <div style={styles.sidebarSection} className={`sydney-referrals-section ${pdfClasses.section}`}>
              <h2 style={styles.sidebarSectionTitle} className={`sydney-sidebar-title ${pdfClasses.sectionTitle}`} data-section="referrals">{t('resume.references.title')}</h2>
              <div style={styles.referralsContent}>
                {data.referrals.providedOnRequest ? (
                  <div style={styles.referralsText}>{t('resume.references.provide_upon_request')}</div>
                ) : ( 
                  data.referrals && data.referrals.map((reference, index) => (
                    <div key={`referral-${index}`} style={styles.referralItem}>
                      <div style={styles.referralName}>{reference.name}</div>
                      {reference.relation && <div style={styles.referralRelation}>{reference.relation}</div>}
                      <div style={styles.referralContact}>
      ...
      {isPdfMode && (
        <style dangerouslySetInnerHTML={{ __html: `
          ...
          @media print {
            ...
            .sydney-exp-item, .sydney-edu-item, .sydney-internship-item, .sydney-course-item, .sydney-custom-item {
              page-break-inside: avoid !important;
              break-inside: avoid !important;
            }
            .sydney-section-title, .sydney-sidebar-title {
