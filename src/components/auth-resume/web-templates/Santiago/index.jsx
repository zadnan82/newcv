...
import { getSantiagoStyles } from './SantiagoStyles';
import { useTranslation } from 'react-i18next';

const Santiago = ({ formData, customSettings, darkMode, isPdfMode = false }) => {
  ...
  const styles = getSantiagoStyles(darkMode, settings, isPdfMode);
  ...
  return (
    <div style={styles.container} className={`santiago-template ${pdfClasses.container}`}>
      {/* Modern header with profile info and contact details */}
      <header style={styles.header} className={`santiago-header ${pdfClasses.header}`}>
      ...
      {/* Personal Details Info Strip */}
      {hasPersonalDetails() && (
        <div style={styles.personalInfoStrip}>
          {data.personal_info.address && (
      ...
      <div style={styles.contentLayout}>
        <div style={styles.mainContent}>
          ...
          {data.personal_info.summary && (
            <div style={styles.section} className={`santiago-summary-section ${pdfClasses.section}`}>
              <h2 style={styles.sectionTitle} className={`santiago-section-title ${pdfClasses.sectionTitle}`} data-section="summary">
          ...
          {/* Work Experience */}
          {hasExperiences() && (
            <div style={styles.section} className={`santiago-experience-section ${pdfClasses.section}`}>
              <h2 style={styles.sectionTitle} className={`santiago-section-title ${pdfClasses.sectionTitle}`} data-section="experience">
              ...
              <div style={styles.sectionContent}>
                {data.experiences
                  ...
                  .map((exp, index) => (
                    <div key={index} style={styles.expItem} className={`santiago-exp-item ${pdfClasses.expItem}`}>
          ...
          {/* Education */}
          {hasEducation() && (
            <div style={styles.section} className={`santiago-education-section ${pdfClasses.section}`}>
              <h2 style={styles.sectionTitle} className={`santiago-section-title ${pdfClasses.sectionTitle}`} data-section="education">
              ...
              <div style={styles.sectionContent}>
                {data.educations
                  ...
                  .map((edu, index) => (
                    <div key={index} style={styles.expItem} className={`santiago-edu-item ${pdfClasses.expItem}`}>
                      <div style={styles.expHeader}>
                        <div style={styles.expDate}>
          ...
          {/* Internships */}
          {hasInternships() && (
            <div style={styles.section} className={`santiago-internships-section ${pdfClasses.section}`}>
              <h2 style={styles.sectionTitle} className={`santiago-section-title ${pdfClasses.sectionTitle}`} data-section="internships">
              ...
              <div style={styles.sectionContent}>
                {data.internships
                  ...
                  .map((internship, index) => (
                    <div key={index} style={styles.expItem} className={`santiago-internship-item ${pdfClasses.expItem}`}>
                      <div style={styles.expHeader}>
                        <div style={styles.expDate}>
          ...
          {hasCourses() && (
            <div style={styles.section} className={`santiago-courses-section ${pdfClasses.section}`}>
              <h2 style={styles.sectionTitle} className={`santiago-section-title ${pdfClasses.sectionTitle}`} data-section="courses">
              ...
              <div style={styles.sectionContent}>
                {data.courses
                  ...
                  .map((course, index) => (
                    <div key={index} style={styles.expItem} className={`santiago-course-item ${pdfClasses.expItem}`}>
                      <div style={styles.expHeader}>
          ...
          {hasCustomSections() && 
            data.custom_sections
              ...
              .map((section, sectionIndex) => (
                <div key={`custom-${sectionIndex}`} style={styles.section} className={`santiago-custom-section ${pdfClasses.section}`}>
                  <h2 style={styles.sectionTitle} className={`santiago-section-title ${pdfClasses.sectionTitle}`} data-section={`custom-${sectionIndex}`}>
                  ...
                  <div style={styles.sectionContent}>
                    ...
                    {section.items && section.items.length > 0 ? (
                      section.items.map((item, itemIndex) => (
                        <div key={`custom-item-${sectionIndex}-${itemIndex}`} style={styles.expItem} className={`santiago-custom-item ${pdfClasses.expItem}`}>
                          <div style={styles.expHeader}>
                      ...
                      <div style={styles.expItem} className={`santiago-custom-content ${pdfClasses.expItem}`}>
          ...
          {hasExtracurriculars() && (
            <div style={styles.section} className={`santiago-extracurriculars-section ${pdfClasses.section}`}>
              <h2 style={styles.sectionTitle} className={`santiago-section-title ${pdfClasses.sectionTitle}`} data-section="extracurriculars">
                {t('resume.extracurricular.activity')}
              </h2>
              <div style={styles.sectionContent}>
                {data.extracurriculars.map((activity, index) => (
                  <div key={index} style={styles.expItem} className={`santiago-extracurricular-item ${pdfClasses.expItem}`}>
                    <div style={styles.expHeader}></div>
                    <div style={styles.expItemSecond}>
          ...
          {/* Skills */}
          {hasSkills() && (
            <div style={styles.skillsSection} className={`santiago-skills-section ${pdfClasses.section}`}>
              <h2 style={styles.sectionTitle} className={`santiago-section-title ${pdfClasses.sectionTitle}`} data-section="skills">
          ...
          {/* Languages */}
          {hasLanguages() && (
            <div style={styles.languagesSection} className={`santiago-languages-section ${pdfClasses.section}`}>
              <h2 style={styles.sectionTitle} className={`santiago-section-title ${pdfClasses.sectionTitle}`} data-section="languages">
          ...
          {/* Hobbies & Interests */}
          {hasHobbies() && (
            <div style={styles.hobbiesSection} className={`santiago-hobbies-section ${pdfClasses.section}`}>
              <h2 style={styles.sectionTitle} className={`santiago-section-title ${pdfClasses.sectionTitle}`} data-section="hobbies">
          ...
          {hasReferences() && (
            <div style={styles.referralsSection} className={`santiago-referrals-section ${pdfClasses.section}`}>
              <h2 style={styles.sectionTitle} className={`santiago-section-title ${pdfClasses.sectionTitle}`} data-section="referrals">
      ...
      {isPdfMode && (
        <style dangerouslySetInnerHTML={{ __html: `
          ...
          @media print {
            ...
            .santiago-exp-item, .santiago-edu-item, .santiago-internship-item, .santiago-course-item, .santiago-custom-item {
              page-break-inside: avoid !important;
              break-inside: avoid !important;
            }
            .santiago-section-title, .santiago-sidebar-title {
