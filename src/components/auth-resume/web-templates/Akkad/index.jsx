...
import { getAkkadStyles } from './AkkadStyles';
import { useTranslation } from 'react-i18next';

const Akkad = ({ formData, customSettings, darkMode, isPdfMode = false }) => {
  const { t } = useTranslation();
    ...
    const styles = getAkkadStyles(darkMode, settings, isPdfMode);

  return (
    <div style={styles.container} className={`akkad-template ${pdfClasses.container}`}>
      {/* Modern header with asymmetric design */}
      <header style={styles.header} className={`akkad-header ${pdfClasses.header}`}>
      ...
      {/* Two column layout - modern grid approach */}
      <div style={styles.contentLayout}>
        {/* Main content column */}
        <div style={styles.mainColumn} className="akkad-main-column">
          {/* Professional Summary */}
          {data.personal_info.summary && (
            <div style={styles.section} className={`akkad-summary-section ${pdfClasses.section}`}>
              <h2 style={styles.sectionTitle} className={`akkad-section-title ${pdfClasses.sectionTitle}`} data-section="summary">
          ...
          {/* Work Experience */}
          {hasExperiences() && (
            <div style={styles.section} className={`akkad-experience-section ${pdfClasses.section}`}>
              <h2 style={styles.sectionTitle} className={`akkad-section-title ${pdfClasses.sectionTitle}`} data-section="experience">
              ...
              <div style={styles.sectionContent}>
                {data.experiences
                  ...
                  .map((exp, index) => (
                    <div key={index} style={styles.expItem} className={`akkad-exp-item ${pdfClasses.expItem}`}>
          ...
          {/* Education */}
          {hasEducation() && (
            <div style={styles.section} className={`akkad-education-section ${pdfClasses.section}`}>
              <h2 style={styles.sectionTitle} className={`akkad-section-title ${pdfClasses.sectionTitle}`} data-section="education">
              ...
              <div style={styles.sectionContent}>
                {data.educations
                  ...
                  .map((edu, index) => (
                    <div key={index} style={styles.expItem} className={`akkad-edu-item ${pdfClasses.expItem}`}>
                      <div style={styles.expHeader}>
          ...
          {/* Internships */}
          {hasInternships() && (
            <div style={styles.section} className={`akkad-internships-section ${pdfClasses.section}`}>
              <h2 style={styles.sectionTitle} className={`akkad-section-title ${pdfClasses.sectionTitle}`} data-section="internships">
              ...
              <div style={styles.sectionContent}>
                {data.internships
                  ...
                  .map((internship, index) => (
                    <div key={index} style={styles.expItem} className={`akkad-internship-item ${pdfClasses.expItem}`}>
                      <div style={styles.expHeader}>
          ...
          {hasCourses() && (
            <div style={styles.section} className={`akkad-courses-section ${pdfClasses.section}`}>
              <h2 style={styles.sectionTitle} className={`akkad-section-title ${pdfClasses.sectionTitle}`} data-section="courses">
              ...
              <div style={styles.sectionContent}>
                {data.courses
                  ...
                  .map((course, index) => (
                    <div key={index} style={styles.expItem} className={`akkad-course-item ${pdfClasses.expItem}`}>
                      <div style={styles.expHeader}>
          ...
          {hasCustomSections() && 
            data.custom_sections
              ...
              .map((section, sectionIndex) => (
                <div key={`custom-${sectionIndex}`} style={styles.section} className={`akkad-custom-section ${pdfClasses.section}`}>
                  <h2 style={styles.sectionTitle} className={`akkad-section-title ${pdfClasses.sectionTitle}`} data-section={`custom-${sectionIndex}`}>
                  ...
                  <div style={styles.sectionContent}>
                    ...
                    {section.items && section.items.length > 0 ? (
                      section.items.map((item, itemIndex) => (
                        <div key={`custom-item-${sectionIndex}-${itemIndex}`} style={styles.expItem} className={`akkad-custom-item ${pdfClasses.expItem}`}>
                          <div style={styles.expHeader}>
                      ...
                      <div style={styles.expItem} className={`akkad-custom-content ${pdfClasses.expItem}`}>
          ...
          {hasExtracurriculars() && (
            <div style={styles.section} className={`akkad-extracurriculars-section ${pdfClasses.section}`}>
              <h2 style={styles.sectionTitle} className={`akkad-section-title ${pdfClasses.sectionTitle}`} data-section="extracurriculars">
                {t('resume.extracurricular.activity')}
              </h2>
              <div style={styles.sectionContent}>
                {data.extracurriculars.map((activity, index) => (
                  <div key={index} style={styles.expItem} className={`akkad-extracurricular-item ${pdfClasses.expItem}`}>
                    <div style={styles.expHeader}>
        ...
        <div style={styles.sidebar} className={`akkad-sidebar ${pdfClasses.sidebar}`}>
          {/* Personal Information */}
          {hasPersonalDetails() && (
            <div style={styles.sidebarSection} className={`akkad-personal-details-section ${pdfClasses.section}`}>
              <h2 style={styles.sidebarSectionTitle} className={`akkad-sidebar-title ${pdfClasses.sectionTitle}`} data-section="personal-details">
          ...
          {/* Skills */}
          {hasSkills() && (
            <div style={styles.sidebarSection} className={`akkad-skills-section ${pdfClasses.section}`}>
              <h2 style={styles.sidebarSectionTitle} className={`akkad-sidebar-title ${pdfClasses.sectionTitle}`} data-section="skills">
          ...
          {/* Languages */}
          {hasLanguages() && (
            <div style={styles.sidebarSection} className={`akkad-languages-section ${pdfClasses.section}`}>
              <h2 style={styles.sidebarSectionTitle} className={`akkad-sidebar-title ${pdfClasses.sectionTitle}`} data-section="languages">
          ...
          {/* Hobbies & Interests */}
          {hasHobbies() && (
            <div style={styles.sidebarSection} className={`akkad-hobbies-section ${pdfClasses.section}`}>
              <h2 style={styles.sidebarSectionTitle} className={`akkad-sidebar-title ${pdfClasses.sectionTitle}`} data-section="hobbies">
          ...
          {hasReferences() && (
            <div style={styles.sidebarSection} className={`akkad-referrals-section ${pdfClasses.section}`}>
              <h2 style={styles.sidebarSectionTitle} className={`akkad-sidebar-title ${pdfClasses.sectionTitle}`} data-section="referrals">
                {t('resume.references.title')}
              </h2>
              <div style={styles.sectionContent}>
                {data.referrals.providedOnRequest ? (
                  <div style={styles.referralsText}>
      ...
      {isPdfMode && (
        <style dangerouslySetInnerHTML={{ __html: `
          ...
          @media print {
            ...
            .akkad-exp-item, .akkad-edu-item, .akkad-internship-item, .akkad-course-item, .akkad-custom-item {
              page-break-inside: avoid !important;
              break-inside: avoid !important;
            }
            .akkad-section-title, .akkad-sidebar-title {
