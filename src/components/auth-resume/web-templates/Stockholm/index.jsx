...
import { getStockholmStyles } from './StockholmStyles';
import { useTranslation } from 'react-i18next'; // Added for i18n support
 
// In Stockholm.jsx, at the beginning of the component
const Stockholm = ({ formData, customSettings, darkMode, isPdfMode = false }) => {
  ...
  const styles = getStockholmStyles(darkMode, settings, isPdfMode);

  return (
    <div style={styles.container} className={`stockholm-template ${pdfClasses.container}`}>
      {/* Header with profile info and contact details */}
      <header style={styles.header} className={`stockholm-header ${pdfClasses.header}`}>
...
/>
      ...
      <div style={styles.contentLayout}>
        {/* Main column (left) */}
        <div style={styles.mainColumn} className="stockholm-main-column">
          {/* Professional Summary */}
          {/* Professional Summary */}
{data.personal_info.summary && (
  <div style={styles.section} className={`stockholm-summary-section ${pdfClasses.section}`}>
    <h2 style={styles.sectionTitle} className={`stockholm-section-title ${pdfClasses.sectionTitle}`} data-section="summary">{t('resume.personal_info.summary')}</h2>
    <div style={styles.sectionContent}>
      <p style={styles.summary}>{data.personal_info.summary}</p>
          ...
          {/* Work Experience */}
          {hasExperiences() && (
            <div style={styles.section} className={`stockholm-experience-section ${pdfClasses.section}`}>
              <h2 style={styles.sectionTitle} className={`stockholm-section-title ${pdfClasses.sectionTitle}`} data-section="experience">{t('resume.experience.title')}</h2>
              <div style={styles.sectionContent}>
                {data.experiences
                  .filter(exp => exp && exp.company)
                  .map((exp, index) => (
                    <div key={index} style={styles.expItem} className={`stockholm-exp-item ${pdfClasses.expItem}`}>
          ...
          {/* Education */}
          {hasEducation() && (
            <div style={styles.section} className={`stockholm-education-section ${pdfClasses.section}`}>
              <h2 style={styles.sectionTitle} className={`stockholm-section-title ${pdfClasses.sectionTitle}`} data-section="education">{t('resume.education.title')}</h2>
              <div style={styles.sectionContent}>
                {data.educations
                  .filter(edu => edu && edu.institution)
                  .map((edu, index) => (
                    <div key={index} style={styles.expItem} className={`stockholm-edu-item ${pdfClasses.expItem}`}>
                      <div style={styles.expHeader}>
          ...
          {/* Internships */}
          {hasInternships() && (
            <div style={styles.section} className={`stockholm-internships-section ${pdfClasses.section}`}>
              <h2 style={styles.sectionTitle} className={`stockholm-section-title ${pdfClasses.sectionTitle}`} data-section="internships">{t('resume.internships.title')}</h2>
              <div style={styles.sectionContent}>
                {data.internships
                  .filter(internship => internship && internship.company)
                  .map((internship, index) => (
                    <div key={index} style={styles.expItem} className={`stockholm-internship-item ${pdfClasses.expItem}`}>
                      <div style={styles.expHeader}>
          ...
          {hasCourses() && (
            <div style={styles.section} className={`stockholm-courses-section ${pdfClasses.section}`}>
              <h2 style={styles.sectionTitle} className={`stockholm-section-title ${pdfClasses.sectionTitle}`} data-section="courses">{t('resume.courses.title')}</h2>
              <div style={styles.sectionContent}>
                {data.courses
                  .filter(course => course && course.name)
                  .map((course, index) => (
                    <div key={index} style={styles.expItem} className={`stockholm-course-item ${pdfClasses.expItem}`}>
                      <div style={styles.expHeader}>
          ...
          {hasCustomSections() && 
            data.custom_sections
              ...
              .map((section, sectionIndex) => (
                <div key={`custom-${sectionIndex}`} style={styles.section} className={`stockholm-custom-section ${pdfClasses.section}`}>
                  <h2 style={styles.sectionTitle} className={`stockholm-section-title ${pdfClasses.sectionTitle}`} data-section={`custom-${sectionIndex}`}>{section.title || t('resume.custom_sections.title')}</h2>
                  <div style={styles.sectionContent}>
                    {/* If the section has items array, render them as individual entries */}
                    {section.items && section.items.length > 0 ? (
                      section.items.map((item, itemIndex) => (
                        <div key={`custom-item-${sectionIndex}-${itemIndex}`} style={styles.expItem} className={`stockholm-custom-item ${pdfClasses.expItem}`}>
                          <div style={styles.expHeader}>
                      ...
                      <div style={styles.expItem} className={`stockholm-custom-content ${pdfClasses.expItem}`}>
            ...
            {hasExtracurriculars()  && (
              <div style={styles.section} className={`stockholm-extracurriculars-section ${pdfClasses.section}`}>
                <h2 style={styles.sectionTitle} className={`stockholm-section-title ${pdfClasses.sectionTitle}`} data-section="extracurriculars">{t('resume.extracurricular.activity')}</h2>
                <div style={styles.sectionContent}>
                  {data.extracurriculars.map((activity, index) => (
                    <div key={index} style={styles.expItem} className={`stockholm-extracurricular-item ${pdfClasses.expItem}`}>
                      <div style={styles.expHeader}>
        ...
        <div style={styles.sidebar} className={`stockholm-sidebar ${pdfClasses.sidebar}`}>
          {/* Personal Information */}
          {hasPersonalDetails() && (
            <div style={styles.sidebarSection} className={`stockholm-personal-details-section ${pdfClasses.section}`}>
              <h2 style={styles.sidebarSectionTitle} className={`stockholm-sidebar-title ${pdfClasses.sectionTitle}`} data-section="personal-details">{t('resume.personal_info.title')}</h2>
          ...
          {/* Skills */}
          {hasSkills() && (
            <div style={styles.sidebarSection} className={`stockholm-skills-section ${pdfClasses.section}`}>
              <h2 style={styles.sidebarSectionTitle} className={`stockholm-sidebar-title ${pdfClasses.sectionTitle}`} data-section="skills">{t('resume.skills.title')}</h2>
          ...
          {/* Languages */}
          {hasLanguages() && (
            <div style={styles.sidebarSection} className={`stockholm-languages-section ${pdfClasses.section}`}>
              <h2 style={styles.sidebarSectionTitle} className={`stockholm-sidebar-title ${pdfClasses.sectionTitle}`} data-section="languages">{t('resume.languages.title')}</h2>
          ...
          {/* Hobbies & Interests */}
          {hasHobbies() && (
            <div style={styles.sidebarSection} className={`stockholm-hobbies-section ${pdfClasses.section}`}>
              <h2 style={styles.sidebarSectionTitle} className={`stockholm-sidebar-title ${pdfClasses.sectionTitle}`} data-section="hobbies">{t('resume.hobbies.title')}</h2>
    ...
    {/* Referrals */}
    {hasReferences() && (
            <div style={styles.section} className={`stockholm-referrals-section ${pdfClasses.section}`}>
              <h2 style={styles.sectionTitle} className={`stockholm-section-title ${pdfClasses.sectionTitle}`} data-section="referrals">{t('resume.references.title')}</h2>
              <div style={styles.sectionContent}>
                {data.referrals.providedOnRequest ? (
                  <div style={styles.expItem} className={`stockholm-referrals-text ${pdfClasses.expItem}`}>
                    <p style={styles.referralsText}>{t('resume.references.provide_upon_request')}</p>
                  </div>
                ) : ( 
                  data.referrals && data.referrals.map((reference, index) => (
                    <div key={`referral-${index}`} style={styles.expItem} className={`stockholm-referral-item ${pdfClasses.expItem}`}>
      ...
      {isPdfMode && (
        <style dangerouslySetInnerHTML={{ __html: `
          ...
          @media print {
            ...
            .stockholm-exp-item, .stockholm-edu-item, .stockholm-internship-item, .stockholm-course-item, .stockholm-custom-item {
              page-break-inside: avoid !important;
              break-inside: avoid !important;
            }
            .stockholm-section-title, .stockholm-sidebar-title {
